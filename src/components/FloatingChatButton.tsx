    ...
    <>
      ...
      <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50">
        ...
        <button
          ...
          className={`group relative w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-500 flex items-center justify-center ${isExpanded ? 'rotate-180 scale-110' : ''
            }`}
